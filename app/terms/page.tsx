...
export const metadata: Metadata = {
  title: 'Terms of Service | Insulin Pump Insurance UK',
  description: 'Terms of Service for Insulin Pump Insurance UK. Please read our terms and conditions before using our website and insurance comparison services.',
  alternates: {
    canonical: 'https://insulinpumpinsurance.quest/terms',
  },
}
    ...
    <div className="min-h-screen py-16 px-4">
      <article className="max-w-4xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-400">In no event shall Insulin Pump Insurance UK or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our website, even if we or our authorized representative has been notified orally or in writing of the possibility of such damage.</p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-bold text-white mb-4">5. Contact Us</h2>
          <p className="text-slate-400">If you have any questions about these Terms of Service, please contact us at: support@insulinpumpinsurance.quest</p>
        </section>
      </article>
    </div>
  )
