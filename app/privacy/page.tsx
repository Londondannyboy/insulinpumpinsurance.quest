...
export const metadata: Metadata = {
  title: 'Privacy Policy | Insulin Pump Insurance UK',
  description: 'Privacy policy for Insulin Pump Insurance UK. How we collect, use, and protect your personal data.',
  alternates: {
    canonical: 'https://insulinpumpinsurance.quest/privacy',
  },
}
      ...
      <article className="max-w-4xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-400 mb-4">
            Insulin Pump Insurance UK operates the insulinpumpinsurance.quest website. We are committed to protecting your privacy and ensuring you have a positive experience on our site.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-400">If you have questions about this Privacy Policy, please contact us at: support@insulinpumpinsurance.quest</p>
        </section>
      </article>
    </div>
  )
